...
export const ACTIONS = {
	...
	"frame-step-backward": {
		description: "Retroceder um quadro",
		category: "navigation",
	},
	"jump-forward": {
	...
	split: {
		description: "Dividir elementos no playhead",
		category: "editing",
	},
	"split-left": {
	...
	"paste-copied": {
		description: "Colar elementos no playhead",
		category: "editing",
	},
	"toggle-snapping": {
		description: "Ativar/desativar encaixe",
		category: "editing",
	},
	...
	"toggle-source-audio": {
		description: "Extrair ou recuperar áudio original",
		category: "editing",
	},
	"select-all": {
	...
	"cancel-interaction": {
		description: "Cancelar interação atual",
		category: "controls",
	},
	"deselect-all": {
	...
	"toggle-elements-muted-selected": {
		description: "Ativar/desativar mudo dos elementos selecionados",
		category: "selection",
	},
	...
	"toggle-bookmark": {
		description: "Adicionar/remover marcador no playhead",
		category: "timeline",
	},
	undo: {
