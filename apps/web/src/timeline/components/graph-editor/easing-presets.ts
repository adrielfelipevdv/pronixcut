...
export const BUILTIN_PRESETS: EasingPreset[] = [
	...
	{ id: "ease-out", label: "Suavizar saída", value: [0, 0, 0.2, 1] },
	{ id: "ease-in", label: "Suavizar entrada", value: [0.8, 0, 1, 1] },
	{ id: "ease-in-out", label: "Entrada e saída", value: [0.4, 0, 0.2, 1] },
